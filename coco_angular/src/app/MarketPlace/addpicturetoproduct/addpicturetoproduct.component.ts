...
@Component({
    selector: 'app-addpicturetoproduct',
    templateUrl: './addpicturetoproduct.component.html',
    styleUrls: ['./addpicturetoproduct.component.scss']
})
export class AddpicturetoproductComponent implements OnInit {
    idproduct!: number;
    idPicture!: number;
